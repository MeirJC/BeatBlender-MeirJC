  ...
  const logo = (
    <>
      <svg
        ...
        viewBox="0 0 191.076 191.076"
      >
        <path
          d="M95.538,191.076C42.858,191.076,0,148.218,0,95.538S42.858,0,95.538,0s95.538,42.858,95.538,95.538
    ...
    <div className="navbar">
      ...
      <ul className={click ? "nav-menu active" : "nav-menu"}>
        <li className="nav-item">
          <Link to="/streetlights">Street Lights</Link>
        </li>
        <li className="nav-item">
          <Link to="/concretejungle">Concrete Jungle</Link>
        </li>
        <li className="nav-item">
      ...
      <div className="hamburger" onClick={handleClick}>
        {click ? (
          <FaTimes
            size={42}
            style={{ color: "#fafafa", marginRight: "0.75rem" }}
          />
        ) : (
          <FaBars
            size={42}
